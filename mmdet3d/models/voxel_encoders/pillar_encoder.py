...
#     def __init__(self,  num_point_features, voxel_size, grid_size, point_cloud_range, num_filters, norm_cfg=dict(type='BN1d', eps=1e-3, momentum=0.01)):
#         super(DynamicPillarVFE, self).__init__()
...
#             pfn_layers.append(
#                  PFNLayerV2(in_filters, out_filters, self.norm_cfg, last_layer=(i >= len(num_filters) - 2))
#             )
#         self.pfn_layers = nn.ModuleList(pfn_layers)
