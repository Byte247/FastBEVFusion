    ...
    def forward(self, voxel_features, voxel_coords):
        ...
        Returns:
            bacth_dict (dict):
                ...
                - ...
        '''
        voxel_info = self.input_layer(voxel_features, voxel_coords)
        ...
        pillar_features = output
        voxel_coords = voxel_info[f'voxel_coors_stage{self.stage_num - 1}']
        return pillar_features, voxel_coords
